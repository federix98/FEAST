...
public class SenScriptConditionElementAnd extends SenScriptConditionElement {

	protected SenScriptConditionElement conditionLeft;
	protected SenScriptConditionElement conditionRight;

	public SenScriptConditionElementAnd(SenScriptConditionElement conditionL, SenScriptConditionElement conditionR) {
